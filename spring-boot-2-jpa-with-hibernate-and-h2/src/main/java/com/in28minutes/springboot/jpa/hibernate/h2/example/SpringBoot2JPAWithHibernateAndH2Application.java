...
public class SpringBoot2JPAWithHibernateAndH2Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		logger.info("Inserting -> {}", repository.save(new Student("John", "A1234657", "test")));

		logger.info("Update 10003 -> {}", repository.save(new Student(10001L, "Name-Updated", "New-Passport", "test")));
